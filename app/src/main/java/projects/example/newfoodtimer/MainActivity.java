...
public class MainActivity extends AppCompatActivity {
    ...
    //private MainActivity.BackPressCloseHandler backPressCloseHandler;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intentHome = new Intent(MainActivity.this, GeneralTimer.class);
...
//            mEditTextInput_sec = findViewById(R.id.edit_text_input_sec);
        ...
        mTextDetail2 = findViewById(R.id.text_detail2);
...
//                    }
        ...
        String text_title = intent.getExtras().getString("text_title");
...
//                    mp.start();
    ...
    private void updateCountDownText() {
        ...
        String timeLeftFormatted_1;
        if (hours > 0) {
            timeLeftFormatted_1 = String.format(Locale.getDefault(),
        ...
        mTextViewCountDown.setText(timeLeftFormatted_1);
    }
...
//                mEditTextInput_sec.setVisibility(View.VISIBLE);
    ...
    protected void onStart() {
        ...
        numberpicker1.setValue((int)fromButton);
        numberpicker2.setValue((int)((fromButton - (int)fromButton)*60));
...
//        String leave = getResources().getString(R.string.leave);
//        String yes = getResources().getString(R.string.yes);
//        String no = getResources().getString(R.string.no);
//
//        AlertDialog.Builder alBuilder = new AlertDialog.Builder(MainActivity.this);
//            alBuilder.setMessage(leave);
//
//            // "예" 버튼을 누르면 실행되는 리스너
